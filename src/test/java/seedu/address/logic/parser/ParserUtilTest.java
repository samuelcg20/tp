...
//         assertThrows(ParseException.class, () -> ParserUtil.parseTags(Arrays.asList(VALID_ROLE_1, INVALID_ROLE)));
//     }
...
//         Set<Role> actualTagSet = ParserUtil.parseTags(Arrays.asList(VALID_ROLE_1, VALID_ROLE_2));
