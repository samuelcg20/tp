...
public abstract class AddCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Adds a member or event to the address book.\n"
            + "Parameters for member: add member n/[member name] p/[phone] e/[email] y/[year(1-4)] t/[roles...]\n"
            + "Example: add member n/John Doe p/98765432 e/johndoe@gmail.com y/1 t/President\n"
